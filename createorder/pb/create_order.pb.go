...
func (x *CreateOrderMessage) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *CreateOrderMessage) GetDescription() string {
	if x != nil {
...
func (x *CreateOrderMessage) GetQuantity() int32 {
	if x != nil {
		return x.Quantity
	}
	return 0
...
func (x *CreateOrderMessage) GetPrice() float32 {
	if x != nil {
		return x.Price
	}
	return 0
...
var file_create_order_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x22, 0x7e, 0x0a, 0x12, 0x43,
	...
	0x20, 0x01, 0x28, 0x02, 0x52, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x42, 0x10, 0x5a, 0x0e, 0x63,
	0x72, 0x65, 0x61, 0x74, 0x65, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70,
